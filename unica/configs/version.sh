...
# NPL skin on UN1CA engine (fork: cosinemyan/NPLROM_UN1CA)

export NPL_VERSION="1.0-STABLE"
...
#
# Version name
ROM_VERSION="NPL_${NPL_VERSION}_${NPL_CODENAME}_${VERSION_MAJOR}.${VERSION_MINOR}.${VERSION_PATCH}"
