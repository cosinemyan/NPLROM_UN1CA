...
# NPL: Galaxy S23+ (dm2q) — full UN1CA-style target config (was a stub).
#
# TARGET_FIRMWARE format: MODEL/CSC/IMEI_or_TAC
# samloader only needs a valid TAC (first 8 digits) for FUS.
#
...
# SM-S916B EUX — TAC 35814970 (S23+); placeholder serial like UN1CA dm1q/dm3q
TARGET_FIRMWARE="SM-S916B/EUX/358149701234563"
...
# Partitions (same super layout family as dm1q / dm3q)
