# Overlay UN1CA Settings (including Theme Trial) onto an apktool-decoded SecSettings.apk.
# Sourced from customize.sh (Step 4) and scripts/patch_system_apk.sh (apk-only).
# Requires: MODPATH, APKTOOL_DIR, SMALI_PATCH, LOG, EVAL.
...
unset PATCH_INST CONTENT SEARCH_INDEX_RESOURCES SEARCH_INDEX_RESOURCES_SMALI
LOG_STEP_OUT
